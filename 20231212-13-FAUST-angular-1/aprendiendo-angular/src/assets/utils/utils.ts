...
function productCard(producto:any) {
...
function proveedorItem(orden:any) {
...
const tableRow = document.createElement('tr')
    ...
    tableColumnItems.textContent = orden.productos.reduce((acc:number,p:any) => acc+= p.cantidad,0)
